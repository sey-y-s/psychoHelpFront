...
export const routes: Routes = [
  ...
  /* {
    ...
    loadComponent: () =>
      import("./pages/register/psychologue/psychologue").then(
        (m) => m.Psychologue,
      ),
  },
  ...
  //chemin pour acceder a la page d´inscription d´un citoyen
  {
    ...
    loadComponent: () =>
      import("./pages/register/citoyen/citoyen").then((m) => m.Citoyen),
  },*/
  {
    path: "login",
  ...
  /*{
    path: "register/admin",
    loadComponent: () =>
      import("./pages/register/admin/admin").then((m) => m.Admin),
  },*/
  ...
  // Rendez-vous (connecté)
  {
    ...
    loadComponent: () =>
      import("./pages/rdv/rdv.component").then(
        (m) => m.PriseRendezvousComponent,
      ),
  ...
  },
  {
    path: "admin/conseils",
    loadComponent: () =>
      import("./pages/admin-conseil-validation/admin-conseil-validation.component").then(
        (m) => m.AdminConseilValidationComponent,
      ),
    canActivate: [authGuard, roleGuard],
    data: { role: "ADMIN" },
  },
  ...
  // Espace psychologue (psy)
  {
    path: "psy/conseils",
    loadComponent: () =>
      import("./pages/psy-mes-conseils/psy-mes-conseils.component").then(
        (m) => m.PsyMesConseilsComponent,
      ),
    canActivate: [authGuard, roleGuard],
