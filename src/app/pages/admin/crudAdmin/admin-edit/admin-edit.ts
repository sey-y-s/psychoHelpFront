...
export class AdminEdit {
  ...
  modifierAdmin() {
    ...
    this.adminService.updateTest(this.id, this.adminForm.value).subscribe({
      ...
      error: (err) => {
        console.log(err);
        this.notif.erreur("Erreur lors de la modification de l'admin")
      },
    });
  }
  redirectList() {
